...
?>
<div class="giiant-crud calibration-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Calibration'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\Calibration'); ?>
    ...
    'attributes' => [
        ...
        'height',
            [
                'attribute'=>'measure',
                'value'=>app\models\Calibration::getMeasureValueLabel($model->measure),
            ],
// generated by schmunk42\giiant\generators\crud\providers\RelationProvider::attributeFormat
[
    'format' => 'html',
    'attribute' => 'sensorid',
    'value' => ($model->getSensor()->one() ? Html::a($model->getSensor()->one()->name, ['sensor/view', 'id' => $model->getSensor()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
        'yourname',
        'youremail:email',
    ],
    ...
    'content' => $this->blocks['app\models\Calibration'],
    'active'  => true,
], ]
                 ]
    );
